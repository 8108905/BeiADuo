...
layui.use(["element", "form", "layer", "okUtils", "okTab", "okLayer", "okContextMenu", "okHoliday", "laydate"], function () {
   ...
   if (a+b==3)
   {
    ...
    function noticeFun() {
        ...
        layer.open({
            type: 0, title: "系统公告", btn: "我知道啦", btnAlign: 'c', content: '"贝阿朵漫画上线啦(^し^)<br/>" +\n' +
                '                    "在此郑重承诺该模板<span style=\'color:#5cb85c\'>永久免费</span>为大家提供<br/>" +\n' +
                '                    "若有更好的建议欢迎<span id=\'noticeQQ\'>加入Q2222Q群</span>一起聊";',
            yes: function (index) {
                if (srcWidth > 800) {
    ...
    $("#alertSkin").click(function () {
        okLayer.open("皮肤动画", "/admin/alertSkin", "50%", "45%", function (layero) {
        }, function () {
        });
    });
